...
b=tar_read(BOXPLOTS)
p.misspecified <- b[[4]]+theme_bw()+theme(axis.text=element_text(size=12),axis.title=element_text(size=18),legend.position="none",
...
#+RESULTS[(2022-07-13 09:15:53) cea73d56781aefa20740267603e5f857128ceaf7]:

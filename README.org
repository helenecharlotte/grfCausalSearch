...
#+RESULTS[(2022-07-12 14:35:04) 000a8d43c4f78a9d5f67999d1986150e843c5b8e]:
...
#+RESULTS[(2022-07-12 14:06:16) 0b7906e227dcc15ea8bd8b601f254f8cc77fb670]:
...
#+BEGIN_SRC R :results file graphics :file ./output/ranking-performance.png :exports none :session *R* :cache yes
  ...
  theme(axis.text=element_text(size=12,angle=45,hjust=1),axis.title=element_text(size=12),
			    ...
			    strip.background = element_blank()),gnet+ggtitle("Net effects")+theme_bw()+theme(axis.text=element_text(size=12,angle=45,hjust=1),axis.title=element_text(size=12),
			    strip.text = element_text(size=12),
			  plot.title=element_text(size=16, hjust=0.5),
			    strip.background = element_blank()),ncol = 1)
#+END_SRC

#+RESULTS[(2022-07-12 14:56:47) 0a1ce64a533dc11b982d2cb25fbb7196833da4f9]:

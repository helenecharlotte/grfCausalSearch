...
#+RESULTS[(2022-01-12 13:50:37) 1b71831ccd21d1229dc4b402b7b82c6981151cfc]:
#+begin_example
Event History Model
                                                                 
 A ~ X1+X2+X3+X4+X5                              binomial(logit) 
 X1 ~ 1                                          Normal          
 X2 ~ 1                                          Normal          
 X3 ~ 1                                          Normal          
 X4 ~ 1                                          Normal          
 X5 ~ 1                                          Normal          
 latenttime1 ~ A+X1+X2+X3+X4+X5                  weibull(2,0.01) 
 latenttime2 ~ A+X1+X2+X3+X4+X5                  weibull(2,0.01) 
 censtime ~ A+X1+X2+X3+X4+X5                     weibull(2,0.04) 
...
fit1a <- riskRegression::ate(event=coxph(Surv(latenttime1,dummy)~A+X1+X2+X3+X4+X5,data=d,x=1,y=1),
                             treatment=A~X1+X2+X3+X4+X5,
                             data=d,
                             times=7)
fit1
#+END_SRC
